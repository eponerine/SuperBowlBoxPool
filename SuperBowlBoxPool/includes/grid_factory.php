<?php
	...
	class grid_factory
	{
		...
		{
			echo $box_id;
			$row = mysql_fetch_array($this->database->query("SELECT * FROM `boxes` WHERE `id` = $box_id AND `name` IS NOT NULL;"));
		...
		{
			$result_sold = mysql_num_rows($this->database->query("SELECT * FROM `boxes` WHERE `name` != '';"));
		...
		{
			$result_unsold = mysql_num_rows($this->database->query("SELECT * FROM `boxes` WHERE `name` = '';"));
		...
		{
			$result_paid = mysql_num_rows($this->database->query("SELECT * FROM `boxes` WHERE `name` != '' AND `is_paid` = 1;"));
		...
		{
			$result_unpaid  = mysql_num_rows($this->database->query("SELECT * FROM `boxes` WHERE `name` != '' AND `is_paid` = 0;"));
		...
		public function count_empty_boxes()
		{
			...
			$row = mysql_fetch_array($box_result);
		...
		public function display_grid_raw()
		{
			...
			$top_numbers  = mysql_fetch_array($this->database->query("SELECT * FROM `random_numbers` WHERE `name` = 'top';"));
			$side_numbers = mysql_fetch_array($this->database->query("SELECT * FROM `random_numbers` WHERE `name` = 'side'"));
